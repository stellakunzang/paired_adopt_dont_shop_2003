...
RSpec.describe "new shelter review page" do
  ...
  it "when a visitor fails to enter a title, a rating, and/or content in the new shelter review form and submit, they see flash message" do
    shelter_1 = Shelter.create(name: "Happy Puppies", address: "55 Street St", city: "Danger Mountain", state: "UT", zip: "80304")
    ...
    expect(page).to have_content("In order to leave a review, you must enter a title, rating, and description.")
    ...
    expect(page).to have_no_content("In order to leave a review, you must enter a title, rating, and description.")
  end
end
