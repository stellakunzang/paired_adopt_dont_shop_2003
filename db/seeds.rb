...
application_4 = AdoptionApplication.create(name: "Ethel", address: "Dainty Lane", city: "Pawnee", state: "IN", zip: "45678", phone_number: "1234-456", description: "I'm a grumpy old lady.")

PetApplication.create(pet_id: kunga.id, adoption_application_id: application_1.id)
PetApplication.create(pet_id: bunnicula.id, adoption_application_id: application_1.id)
PetApplication.create(pet_id: ruby.id, adoption_application_id: application_2.id)
PetApplication.create(pet_id: kunga.id, adoption_application_id: application_2.id)
PetApplication.create(pet_id: ruby.id, adoption_application_id: application_3.id)
PetApplication.create(pet_id: bunnicula.id, adoption_application_id: application_3.id)
PetApplication.create(pet_id: pepper.id, adoption_application_id: application_4.id)
PetApplication.create(pet_id: pie.id, adoption_application_id: application_4.id)
